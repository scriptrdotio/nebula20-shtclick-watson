...
#ifndef APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_BME280_H_
#define APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_BME280_H_

#include "wiced.h"
#include "bluemix_sensors.h"

/**
 * Initialize the BME280 sensor and detect if it is connected properly.
 *
...
/**
 * Read the BME280 data and put it into the MQTT message string.
 *
...
#endif /* APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_BME280_H_ */
