...
/** @file
 *  Defines functions to use the MLX90316 with the Bluemix project.
 */

#ifndef APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_MLX90316_H_
#define APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_MLX90316_H_

#include "wiced.h"
#include "bluemix_sensors.h"

/**
 * Initialize the MLX90316 sensor.
 *
...
/**
 * Read the MLX90316 data and put it into the MQTT message string.
 *
...
#endif /* APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_MLX90316_H_ */
