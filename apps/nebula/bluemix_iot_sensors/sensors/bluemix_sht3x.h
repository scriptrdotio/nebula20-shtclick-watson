...
/** @file
 *  Defines functions to use the SHT3x with the Bluemix project.
 */

#ifndef APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_SHT3X_H_
#define APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_SHT3X_H_

#include "wiced.h"
#include "bluemix_sensors.h"

/**
 * Initialize the SHT3x sensor and detect if it is connected properly.
 *
...
/**
 * Read the SHT3x data and put it into the MQTT message string.
 *
...
#endif /* APPS_NEBULA_BLUEMIX_IOT_SENSORS_SENSORS_BLUEMIX_SHT3X_H_ */
